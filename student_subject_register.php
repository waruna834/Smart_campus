...
$student_name = $user_row['username'];
$student_role = $user_row['role']; // Fetch the user's role
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt->bind_param("isssss", $user_id, $faculty, $program, $subject, $student_name, $student_role);
    $stmt->execute();
    $stmt->close();
}
...
if (isset($_GET['delete'])) {
    ...
    $stmt->execute();
    $stmt->close();
    header("Location: student_subject_register.php"); // Redirect to avoid resubmission
    exit();
}
?>
...
<html lang="en">
    <head>
        ...
        <title>Lecture Subject Registration</title>
    ...
    <body>
        ...
        <!--Student subject register form-->
        <div class="container">
            <h2>Student Subject Registration</h2>
            <form method="POST" action="">
                <div class="form-group">
                    <label for="student">Full Name</label>
                    <input type="text" class="form-control" id="student" name="student" value="<?php echo htmlspecialchars($student_name); ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="role">Role</label>
                    <input type="text" class="form-control" id="role" name="role" value="<?php echo htmlspecialchars($student_role); ?>" readonly>
                </div>
                <div class="form-group">
            ...
            <!--Currently registred subjects table-->
            <h2 class="mt-5">Registered Subjects</h2>
